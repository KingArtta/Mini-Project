<?php
//including the database connection folder
//include('./include/connect.php');

//function for getting products from the database
...
// displaying brands from the database in sidenav
function getbrands(){
    global $con;
...
//displaying categories from the database to the sidenav
...
function search_products(){
    ...
    $num_of_rows= mysqli_num_rows($result_query);
    if($num_of_rows==0){
        echo"<h2 class = 'text-center'>No result. No product found on this category!</h2>";
    }
...
function  cart_item(){
  ...
  //Getting total cart price from the database
...
if($row_count>0){
  ...
  <p class='text-center'><a href='../index.php' class = 'text-dark'>Expolre our products</a></p>";
}

// else{echo"You have no pending order";
// }
    }
  }
}
